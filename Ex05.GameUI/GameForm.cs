...
namespace Ex05.GameUI
{
    public partial class GameForm : Form
    {
        ...
        {
            Player1 = new Player("Red", k_Black);
            Player2 = m_IsAgainstComputer ? new Player("Computer", k_White) : new Player("Yellow", k_White);

            CurrentPlayer = Player1;
            m_OthelloGame = new OthelloGame(r_BoardSize, m_IsAgainstComputer, Player1, Player2);
        ...
        private void playGame()
        {
            ...
            if (m_OthelloGame.HasValidMoves(m_OthelloGame.Player1) || m_OthelloGame.HasValidMoves(m_OthelloGame.Player2))
            {
        ...
        private void makeComputerMove()
        {
            ...
            m_OthelloGame.MakeMove(m_OthelloGame.Player2, m_OthelloGame.ValidMoves[randomIndex]);
            switchPlayer();
            playGame();
        }
        ...
        {
            CurrentPlayer = CurrentPlayer.PlayerName == "Red" ? m_OthelloGame.Player2 : m_OthelloGame.Player1;
        }
        ...
        private void setValidMoves()
        {
            ...
            foreach (string move in m_OthelloGame.ValidMoves)
            {
                ...
                m_PictureBoxBoard[row, col].BackColor = Color.LimeGreen;
        ...
        {
            if (m_OthelloGame.Player1.Score > m_OthelloGame.Player2.Score)
            {
                BlackNumOfWins++;
                getWinnerMessage(m_OthelloGame.Player1);
            }
            else if (m_OthelloGame.Player1.Score < m_OthelloGame.Player2.Score)
            {
                WhiteNumOfWins++;
                getWinnerMessage(m_OthelloGame.Player2);
            }
            else
            {
                getTieMessage();
